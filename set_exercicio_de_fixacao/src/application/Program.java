...
public class Program {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 		Cada instrutor do portal pode ter várioscursos, sendo que um mesmo aluno
		 ...
		 * 
		 * 		O instrutor Alex possui três cursos A, B e C, e deseja saber seu número
		 * 	total de alunos.
		 * 
		 * 	Seu programa deve ler os alunos dos cursos A, B e C do instrutor Alex, depois
		 *  mostrar a quantidade total de alunos dele.
		 * 
		 */
